...
namespace Utilities
{	
#define Exc(id, msg) Exception(id, (const char*)msg, __FILE__, __LINE__, __FUNCTION__)
	...
	public:
		typedef shared_ptr<Exception> ExceptionPtr;
