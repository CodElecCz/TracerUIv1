...
namespace Utilities
{	
#define Exc(id, msg) INodeException(id, (const char*)msg, __FILE__, __LINE__, __FUNCTION__)

	class INodeException : public exception
	{
	public:
		INodeException()
			: m_Empty(true)
	...
	public:
		typedef shared_ptr<INodeException> INodeExceptionPtr;
