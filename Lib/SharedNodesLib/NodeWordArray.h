...
namespace Utilities
{
	namespace Node
	{
		...
		public:
			//area
			void SetReadArea(UINT16 ReadData[], UINT32 ReadDataSize);
			void SetWriteArea(UINT16 WriteData[], UINT32 WriteDataSize);
			void GetWriteArea(UINT16 WriteData[], UINT16 WriteFlag[], PUINT32 WriteDataSize);
			void SetWriteAreaAcknoledge(UINT16 Offset, UINT32 WriteDataSize);
			void Read(UINT16 ReadData[], PUINT32 ReadDataSize);
		...
		public:
			typedef shared_ptr<NodeWordArray> NodeWordArrayPtr;

		private:
#pragma warning(push)
#pragma warning(disable:4251)
			//register
			vector<UINT16> m_ReadData;
			vector<UINT16> m_WriteData;
