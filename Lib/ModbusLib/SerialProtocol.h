...
{	
	namespace ModBus
	{
		...
		public:
			SerialProtocol(void);
			SerialProtocol(const char* COMPort, BaudRate Baudrate = BR_9600, DataBits Databits = DB_8, Parity Parity = P_NONE, StopBits Stopbit = SB_ONE);
			~SerialProtocol(void);
