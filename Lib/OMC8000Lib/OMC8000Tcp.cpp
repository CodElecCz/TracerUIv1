...
#endif
		void OMC8000Tcp::Query(UINT8 WriteData[], UINT16 WriteCount, UINT8 ReadData[], PUINT32 ReadCount, UINT32 ReadCountRequest)
		{
			CAutoLock al(m_OMC8000TcpLock);
			...
			*ReadCount = 0;
			...
			unsigned int sizeCopyTo = (rdataSize<ReadDataAlloc)? rdataSize :ReadDataAlloc;
