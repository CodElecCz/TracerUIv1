...
#define TIMEOUT 1000
		...
		TcpProtocol::TcpProtocol(const char* IPaddress, UINT16 port)
		{
			m_Socket = INVALID_SOCKET;
		...
		void TcpProtocol::Connect(const char* IPaddress, UINT16 port)
		{
		...
		void TcpProtocol::socket_send(UINT8 WriteData[], UINT32 WriteCount)
		{
			//send
		...
		void TcpProtocol::Send(UINT8 WriteData[], UINT32 WriteCount)
		{
		...
		void TcpProtocol::socket_receive(UINT8 ReadData[], PUINT32 ReadCount, UINT32 ReadCountRequest)
		{
		...
		void TcpProtocol::Receive(UINT8 ReadData[], PUINT32 ReadCount, UINT32 ReadCountRequest)
		{
			CAutoLock al(m_SocketLock);
		...
		void TcpProtocol::Query(UINT8 WriteData[], UINT32 WriteCount, UINT8 ReadData[], PUINT32 ReadCount, UINT32 ReadCountRequest)
		{
			CAutoLock al(m_SocketLock);
