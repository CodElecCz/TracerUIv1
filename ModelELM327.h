#ifndef ELM327MODEL_H
#define ELM327MODEL_H

#include <QAbstractItemModel>
#include <QtXml/QDomDocument>
#include <QTimer>
#include "TreeItem.h"
#include "ELM327Lib/ELM327Lib.h"

class Elm327Model : public QAbstractItemModel
{
    Q_OBJECT

public:
    Elm327Model(const QString xmlFile, QObject *parent = nullptr);
    ~Elm327Model();
